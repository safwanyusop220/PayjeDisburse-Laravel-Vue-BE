...
class ReceipientControllerBackup extends Controller
{
    ...
    public function getRules(Request $request)
    {
        ...
        return [
            ...
            'phone_number' => 'required|regex:/^01\d{6,10}$/|digits_between:8,12',
    ...
    public function getMessages()
    {
        return [
            ...
            'postcode.digits' => '* Recipient Postcode number must be 5 digit',
            ...
            'phone_number.digits_between' => '* Recipient Postcode number must between 8 to 12',
