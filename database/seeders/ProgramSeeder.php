...
class ProgramSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Program::create(['created_by_id' => 3 ,'name' => 'BRIM', 'code' => 'BRM001',  'type_id' => '3', "bank_panel" => "3", 'disburse_amount' => '550000.00', 'payment_date' => $paymentDateFormatted, 'status_id' => '1']);

        Program::create(['created_by_id' => 1 ,'name' => 'E-KASIH', 'code' => 'EKH001', 'type_id' => '4', "bank_panel" => "4", 'disburse_amount' => '3900.00', 'payment_date' => $paymentDateFormatted, 'status_id' => '1']);

        Program::create(['created_by_id' => 2 ,'name' => 'BKM2', 'code' => 'BKM002', 'type_id' => '1', "bank_panel" => "1", 'disburse_amount' => '1200.00', 'payment_date' => $paymentDateFormatted, 'status_id' => '1']);
        ...
        Program::create(['created_by_id' => 1 ,'name' => 'BRIM2', 'code' => 'BRM002',  'type_id' => '3', "bank_panel" => "3", 'disburse_amount' => '6500.00', 'payment_date' => $paymentDateFormatted, 'status_id' => '1']);

        Program::create(['created_by_id' => 2 ,'name' => 'E-KASIH2', 'code' => 'EKH002', 'type_id' => '4', "bank_panel" => "4",'disburse_amount' => '6900.00', 'payment_date' => $paymentDateFormatted, 'status_id' => '1']);    
